...
col_transf_tag_EW = 1
col_EW_prop = [col_A_EW, col_G, col_Iy_EW, col_Iz_EW, col_J_EW, col_E, col_transf_tag_EW]
...
col_transf_tag_NS = 2
col_NS_prop = [col_A_NS, col_G, col_Iy_NS, col_Iz_NS, col_J_NS, col_E, col_transf_tag_NS]
...
# base_shear_mrsa_X = modal_combo(np.loadtxt('./mrsa_results/dirX/baseShearX.txt'), lambda_list, damping_ratio, num_modes).sum()
# base_shear_mrsa_Y = modal_combo(np.loadtxt('./mrsa_results/dirY/baseShearY.txt'), lambda_list, damping_ratio, num_modes).sum()
...
# pdelta_fac = (kp * seismic_weight + elf_base_shear) / elf_base_shear

# drift_modif_fac = 1.5  # NZS 1107.5-2004: Table 7.1
...
# story_driftX['DriftX (%)'] *=  (ductility_factor * pdelta_fac * drift_modif_fac)
# story_driftX['DriftY (%)'] *=  (ductility_factor * pdelta_fac * drift_modif_fac)
...
# # Amplify drifts by required factors
# story_driftY['DriftX (%)'] *=  (ductility_factor * pdelta_fac * drift_modif_fac)
# story_driftY['DriftY (%)'] *=  (ductility_factor * pdelta_fac * drift_modif_fac)
