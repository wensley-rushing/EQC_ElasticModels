...
def create_bm_joint_offset(bm_tag, left_col, right_col, floor_num, elev, bm_orient, com_node, smf_node_tags, smf_coords_df, bm_prop, col_prop):
    ...
    bm_Iz = bm_prop[5]
    bm_J = bm_prop[6]
    bm_transf_tag_x = bm_prop[7]
    bm_transf_tag_y = bm_prop[8]

    # ==========================================================
    # Extract properties of panel zone rigid beam elements
    # ==========================================================
    pz_w = col_prop[0] / 2  # Half the depth of panel zone region
    pz_A = col_prop[1] * 100
    pz_E = col_prop[6] * 100
    pz_G = col_prop[2]
    pz_J = col_prop[5]
    ...
    pzone_transf_tag_bm_x = bm_prop[9]
    pzone_transf_tag_bm_y = bm_prop[10]
